...
int rawdms[6] = {1500,1500,2490,1500,1500,1500};     //原点,起点,通电后或H指令会让所有舵机归位到此脉宽.500=0度，1500=居中90度，2500=180度
int olddms[6] = {1500,1500,2490,1500,1500,1500};     //每次转动舵机后保存脉宽值到此,作为下次转动的起点.
int newdms[6] = {1500,1500,2490,1500,1500,1500};     //每次转动舵机后保存脉宽值到此,作为下次转动的起点.
int mindms[6] = { 510,1150,1500,1050, 510, 510};     //定义6个电机在机械臂中可转动的最小信号脉冲微秒值
